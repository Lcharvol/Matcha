...
VALUES
('juliako','abarriel@student.42.fr','${p}','julia','liako','${w}','21','${h}',48.8537, 2.549, true, '${r[2]}', ' ${r[1]}', '/uploads/null', '/uploads/null', '${i[0]}', '5', 'football,parkour,enfant'),
('jpascal','jpascal${_}','${p}','julie','pascal','${w}','45','${h}',48.8856123, 2.3236024, true, '${r[4]}', '${r[6]}', '/uploads/null', '/uploads/null', '${i[1]}', '15', 'football,parkouc,rugby'),
...
('natasha','natasha${_}','${p}','natasha','lagentille','${w}','36','${h}',43.2803051, 5.2650563, true, '${r[5]}', '/uploads/null', '/uploads/null', '/uploads/null', '${i[5]}', '55', 'football,parcoue'),
...
('tferrari','tferrari${_}','${p}','tony','ferrari','man','65','${b}',48.8852991, 2.339703, true, '${r[5]}', '/uploads/null', '/uploads/null', '/uploads/null', '${i[16]}', '45', 'football,parcoure'),
